  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-white flex items-center justify-center">
        ...
        <div className="absolute top-3 left-3 px-2 py-1 rounded-md text-[10px] font-mono uppercase tracking-wider bg-background/80 backdrop-blur border border-border/60">
          {product.category}
        </div>
      ...
      <div className="p-5">
        ...
        <h3 className="mt-1 text-lg font-semibold leading-tight group-hover:text-primary transition-colors line-clamp-2">
          {product.name}
        </h3>
